    ...
    <div class="table-data" style="display: flex; flex-direction:row; width:100%;">
        ...
        <div style=" display:flex; flex-direction:column; text-align:center;">
            ...
            <img width="auto" height="300" class="img"
                src="https://{{ $cdnUrl }}/{{ $video['guid'] }}/{{ $video['thumbnailFileName'] }}" alt="">
            <div class="forms" style="display: flex; flex-direction:row; justify-content:center; align-items:center;">
